  ...
  <div>
        <sidebar :activeIndex="activeIndex">
            <el-row style="padding-top:15px">
                ...
                <el-col :span="4">
                    <el-button type="primary" icon="el-icon-circle-plus-outline" @click="register('ruleForm')">添加</el-button>
                </el-col>
            </el-row>
            <el-row>
                     ...
                     <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="地址" prop="address">
                                <el-row style="width:95%;padding-left:3%">
                                    <el-col :span="12">
                                        <el-cascader
                                            style="width:100%"
                                            :options="options"
  ...
  data () {
    return {
      ...
      rules:
      {
        ...
        path: [
          { required: true, message: '头像必须上唇', trigger: 'blur' }
        ],
        email: [
